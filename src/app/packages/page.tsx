...
export default function Packages(){
    return <div className=" w-full min-h-screen bg-white py-5 md:py-6 lg:py-10">
                    ...
                    <div className="grid grid-cols-1 gap-y-10 gap-x-6 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 xl:gap-x-8">
...

                                {
                                    Array(10).fill(1).map((item, index)=>{
                                        return (
                                            <div className="shadow-lg transition-all duration-700 hover:scale-105">
                            <div className="flex flex-nowrap justify-center items-center rounded-md h-full bg-white hover:bg-indigo-50">
                            <div className="w-full py-8 px-4">
                            <h1 className="text-center my-2 text-lg font-bold text-gray-800 uppercase">basic</h1>
                            <div className="rounded-md font-normal text-sm bg-gradient-to-r from-indigo-400 to-indigo-700 p-3 text-center flex justify-between items-center my-2">
                                ...
                                <div className="flex flex-col text-white">
                                    ...
                                    <div className="w-full flex flex-col item-center text-xsm gap-1 p-1 uppercase">
                                        {
                                            [1,2,3,4,5,6].map((item,i)=><span className="text-center ">Number Of Period 200 Times</span>)
                                        }
                                    </div>
                                    <div className="flex justify-center item-center mt-4">
                                        ...
                                        href="https://sinvestingsolutions.com/register/set-sponsor?slug=basic">Invest Now</Link>
                                    </div>
                                </div>
                            </div>
                        </div>
